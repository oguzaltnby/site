<template>
  ...
  >
    ...
    >
    <div class="card-base p-6 rounded-lg max-w-sm w-full shadow-lg border bg-white/30 dark:bg-black/30 relative overflow-hidden">
    <div class="absolute inset-0 bg-black/30 filter blur-lg z-[-1]"></div>
